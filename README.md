...
| [How well do LLMs reason over tabular data, really?](https://arxiv.org/abs/2505.07453) | arXiv | 2025 | Evaluates robustness of general-purpose LLMs on tabular reasoning under realistic conditions (missing values, duplicates, structural variations). Shows LLM-as-a-judge is more reliable than SacreBleu/BERT-score and reveals significant performance deficits. |
| [LLMOverTab: Tabular Data Augmentation with Language Model-Driven Oversampling](https://www.sciencedirect.com/science/article/pii/S0957417424027192) | Expert Systems with Applications | 2025 | LLM-driven oversampling framework for class-imbalanced tabular data. Uses prompt engineering to generate realistic minority-class samples, outperforming traditional methods like SMOTE in zero/few-shot classification settings. |
...
| [DeLTa: LLM Meeting Decision Trees on Tabular Data](https://openreview.net/forum?id=SRDF3RV0KP) | NeurIPS 2025 Spotlight | 2025 | Uses decision tree rules as logical intermediaries for LLMs instead of serializing raw data. LLM refines Random Forest rules into coherent structures; a Gradient Net then learns sample-wise error corrections. No fine-tuning or per-sample LLM calls at inference. Privacy-preserving (features anonymized). SOTA on diverse tabular benchmarks. |
...
| [Principle-Evolvable Scientific Discovery via Uncertainty Minimization](https://arxiv.org/abs/2602.06448) | arXiv | 2026 | Introduces PiEvo, a principle-evolvable scientific discovery framework that treats discovery as Bayesian optimization over an expanding principle space, using uncertainty minimization and anomaly-driven principle augmentation. |
| [PiFlow: Principle-Aware Scientific Discovery with Multi-Agent Collaboration](https://arxiv.org/abs/2505.15047) | arXiv | 2026 | Proposes an information-theoretic, principle-aware multi-agent framework for scientific discovery, guiding agents to connect hypotheses with evidence and reduce uncertainty more systematically. |
